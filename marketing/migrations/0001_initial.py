# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-03-22 06:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment', models.CharField(choices=[('CASH', 'CASH'), ('PAYTM', 'PAYTM')], max_length=5)),
                ('is_attended', models.BooleanField(default=False)),
                ('code', models.CharField(max_length=15)),
                ('agent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marketing.Event')),
            ],
        ),
        migrations.AddField(
            model_name='user',
            name='department',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='marketing.Department'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
